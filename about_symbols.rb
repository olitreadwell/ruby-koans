...
class AboutSymbols < Neo::Koan
  ...
  # Why is it not a good idea to dynamically create a lot of symbols?
        # It is not a good idea to dynamically create a lot of symbols because those symbols are stored in memory until the program exits, which will hog a large amount of memory
